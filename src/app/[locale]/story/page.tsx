...
export default async function StoryPage({
  ...
  const values = [
    { icon: Heart,  title: 'Purity & Simplicity',           description: t('story.values.purity'),      color: 'bg-[var(--kapunka-sage-light)]' },
    { icon: Leaf,   title: 'Craft & Origin',                 description: t('story.values.craft'),       color: 'bg-[var(--kapunka-sage-medium)]' },
    { icon: Shield, title: 'Dignity & Respect',              description: t('story.values.dignity'),     color: 'bg-[var(--kapunka-taupe)]' },
    { icon: Globe,  title: 'Stewardship',                    description: t('story.values.stewardship'), color: 'bg-[var(--kapunka-sage-light)]' },
    { icon: Scale,  title: 'Consistency & Transparency',     description: t('story.values.consistency'), color: 'bg-[var(--kapunka-sage-medium)]' }
  ];
      ...
      <section className="bg-gradient-to-b from-background to-muted/20 py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl lg:text-5xl font-bold mb-4">{t('story.title')}</h1>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">{t('story.subtitle')}</p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-br from-[var(--kapunka-sage-light)] to-[var(--kapunka-sage-medium)] rounded-lg p-12 text-white">
              ...
              <p className="text-lg leading-relaxed opacity-90">{t('story.essence.description')}</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-6">{t('story.founder.description')}</p>
                <div className="bg-white rounded-lg p-6 shadow-lg">
                  <Quote className="h-8 w-8 text-[var(--kapunka-sage-medium)] mb-4" />
                  <p className="text-xl font-medium italic text-[var(--kapunka-charcoal)]">"{t('story.founder.quote')}"</p>
                </div>
              </div>

              <div className="space-y-6">
                <Card className="border-0 shadow-lg">
                  <CardHeader><CardTitle className="text-xl">Clinical Background</CardTitle></CardHeader>
                  <CardContent><CardDescription className="text-base">
                ...
                <Card className="border-0 shadow-lg">
                  <CardHeader><CardTitle className="text-xl">Medical Studies</CardTitle></CardHeader>
                  <CardContent><CardDescription className="text-base">
                ...
                <Card className="border-0 shadow-lg">
                  <CardHeader><CardTitle className="text-xl">Vision</CardTitle></CardHeader>
                  <CardContent><CardDescription className="text-base">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">{t('story.values.title')}</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-gradient-to-br from-[var(--kapunka-sage-medium)] to-[var(--kapunka-charcoal)] rounded-lg p-8 text-white">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start"><div className="w-2 h-2 bg-white rounded-full mt-2 mr-3 flex-shrink-0" /><span>Sustainably sourced from UNESCO biosphere</span></li>
                  <li className="flex items-start"><div className="w-2 h-2 bg-white rounded-full mt-2 mr-3 flex-shrink-0" /><span>Hand-harvested by local cooperatives</span></li>
                  <li className="flex items-start"><div className="w-2 h-2 bg-white rounded-full mt-2 mr-3 flex-shrink-0" /><span>Cold-pressed to preserve nutrients</span></li>
                  <li className="flex items-start"><div className="w-2 h-2 bg-white rounded-full mt-2 mr-3 flex-shrink-0" /><span>Batch-tracked for full transparency</span></li>
                  <li className="flex items-start"><div className="w-2 h-2 bg-white rounded-full mt-2 mr-3 flex-shrink-0" /><span>Fair trade practices throughout</span></li>
                </ul>
              </div>
            </div>
          </div>
