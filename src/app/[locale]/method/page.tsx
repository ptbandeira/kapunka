...
export default async function MethodPage({
  ...
  const steps = [
    {
      icon: Droplet,
      title: t('method.steps.dose.title'),
      description: t('method.steps.dose.description'),
      color: 'bg-[var(--kapunka-sage-light)]'
    },
    {
      icon: Hand,
      title: t('method.steps.warm.title'),
      description: t('method.steps.warm.description'),
    ...
    {
      icon: Move,
      title: t('method.steps.glide.title'),
      description: t('method.steps.glide.description'),
      color: 'bg-[var(--kapunka-sage-light)]'
    },
    {
      icon: Pause,
      title: t('method.steps.pause.title'),
      description: t('method.steps.pause.description'),
      color: 'bg-[var(--kapunka-sage-medium)]'
    }
  ];
  ...
  const hygieneRules = [
    {
      icon: Shield,
      title: t('method.hygiene.clean_hands'),
      description: 'Always start with clean hands to maintain product purity'
    },
    {
      icon: CheckCircle,
      title: t('method.hygiene.disinfect_tools'),
                        ...
                        <Card className="border-0 shadow-lg">
                          <CardHeader>
                            <div className="flex items-center justify-between">
                              ...
                              <span className="text-sm font-medium text-[var(--kapunka-sage-medium)]">
                                Step {index + 1}
                              </span>
                            </div>
                          </CardHeader>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">
                {t('method.hygiene.title')}
              </h2>
              <p className="text-lg text-muted-foreground">
                Essential hygiene practices for optimal results and product integrity
              </p>
            </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      Following the method ensures consistent results every time
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-[var(--kapunka-sage-medium)] rounded-full mt-2" />
                  <div>
                    <h4 className="font-semibold mb-1">Efficacy</h4>
                    <p className="text-muted-foreground text-sm">
                      Proper technique maximizes the oil's beneficial properties
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      Creates a mindful, calming ritual for both practitioner and client
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      Empowers users with knowledge for better skin care practices
                    </p>
                  </div>
                </div>
              </div>
